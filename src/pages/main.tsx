...
export default function MainPage() {
  return (
    <section className="bg-zinc-950 min-h-screen h-full flex items-center">
      <div className="h-full max-w-[1300px] text-center flex flex-col items-center justify-center m-auto gap-4 p-6 md:p-8">
        ...
        <p className="text-zinc-400 sm:text-xl text-sm sm:leading-8 font-medium lg:text-left">
          ...
          des mauvaises créances et comptabilité intégrée, le tout grâce à des solutions de pointe.
        </p>
        <p className="text-zinc-400 sm:text-xl text-sm sm: font-medium	lg:text-left">
          CommUnite gère le cycle complet de vos créances, vous permettant de vous concentrer sur la
          croissance de votre entreprise. Nous sommes votre allié stratégique pour une gestion
